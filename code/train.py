...
def main():
    ...
    # keep wandb
    wandb.init(project="T2096_dev", entity="bc-ai-it-mrc", name=f"[박진영][{model_args.model_name_or_path}][test]")
...
def run_mrc(
    ...
    def prepare_validation_features(examples):
        ...
        tokenized_examples = tokenizer(
            ...
            return_offsets_mapping=True,
            #return_token_type_ids=False, # roberta모델을 사용할 경우 False, bert를 사용할 경우 True로 표기해야합니다.
            padding="max_length" if data_args.pad_to_max_length else False, # keep default True
        )
    ...
    print()
    print('--- Check Eval Data---')
    print(eval_dataset)
    print()

    print()
    print('--- Check Training Args ---')
    print(training_args)
    print()
